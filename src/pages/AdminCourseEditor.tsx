...
//   title: string;
//   items: ModuleItem[];
//   aiAssignmentEnabled?: boolean; // ✅ NEW
// }
...
//   const [image, setImage] = useState("");
//   const [modules, setModules] = useState<Module[]>([]);
//   const [grandAssessmentEnabled, setGrandAssessmentEnabled] = useState(false);
//   const [loading, setLoading] = useState(true);
...
//       setImage(data?.image || "");
//       setModules(data?.modules || []);
//       setGrandAssessmentEnabled(data?.grandAssessmentEnabled || false);
//       setLoading(false);
//     };
...
//               <input
//                 type="checkbox"
//                 checked={grandAssessmentEnabled}
//                 onChange={(e) =>
//                   setGrandAssessmentEnabled(e.target.checked)
//                 }
//               />
//               <label>Enable AI Grand Assessment</label>
//             </div>
//           </CardContent>
//         </Card>
...
//                   }
//                 />
//                 <label>Enable AI Assignment for this Module</label>
//               </div>
